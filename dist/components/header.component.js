...
var DataTableHeader = (function () {
    ...
    Object.defineProperty(DataTableHeader.prototype, "searchString", {
        get: function () {
            return this.dataTable.searchString;
        },
        set: function (value) {
            this.dataTable.searchString = String(value); // TODO better way to handle that value of number <input> is string?
        },
        enumerable: true,
        configurable: true
    });
